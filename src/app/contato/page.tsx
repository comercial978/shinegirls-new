        ...
        <div className="rounded-[8px] border hairline bg-white p-7 shadow-sm md:p-10">
          ...
          <form className="mt-8 grid gap-4" action={`mailto:${site.email}`} method="post" encType="text/plain">
            <label className="grid gap-2 text-sm font-medium text-charcoal/78">
              Nome
              <input className="focus-ring rounded-[8px] border hairline bg-white px-4 py-3" name="nome" required />
            </label>
            <label className="grid gap-2 text-sm font-medium text-charcoal/78">
              E-mail
              <input className="focus-ring rounded-[8px] border hairline bg-white px-4 py-3" name="email" type="email" required />
            </label>
            <label className="grid gap-2 text-sm font-medium text-charcoal/78">
              Assunto
              <select className="focus-ring rounded-[8px] border hairline bg-white px-4 py-3" name="assunto" defaultValue="Parcerias">
                <option>Parcerias</option>
                <option>Anunciar no site</option>
