  ...
  return (
    <section className="bg-pearl py-16 md:py-24">
      <div className="container-shell grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <SectionHeading
          eyebrow="Nova loja"
          title="A loja sera reconstruida do zero, com curadoria e identidade."
          text="O WooCommerce antigo foi ignorado por estrategia: havia catalogo importado, categorias duplicadas e baixa coerencia de marca. Esta pagina deixa o terreno pronto para uma loja nova."
        />
        <div className="grid gap-4">
          {[
            { icon: ShoppingBag, title: "Drops selecionados", text: "Colecoes menores, editoriais e alinhadas ao posicionamento da Shine Girls." },
            { icon: Gem, title: "Produtos com narrativa", text: "Menos catalogo generico, mais desejo, imagem e recomendacao." },
            { icon: PackageCheck, title: "Stack flexivel", text: "Pronta para Shopify, Stripe, Mercado Pago, CMS headless ou afiliados premium." },
          ].map((item) => (
      ...
      <div className="container-shell mt-12">
        <div className="rounded-[8px] bg-ink p-8 text-pearl md:p-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-pearl/72">
            A base visual e tecnica ja esta pronta para evoluir sem carregar o peso do e-commerce antigo.
          </p>
          <div className="mt-7">
