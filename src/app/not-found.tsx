  ...
  return (
    <section className="bg-pearl py-24">
      <div className="container-shell max-w-2xl text-center">
        ...
        <h1 className="mt-4 font-display text-5xl text-ink">Pagina nao encontrada</h1>
        <p className="mt-5 text-charcoal/70">Este conteudo nao faz parte da nova curadoria Shine Girls.</p>
        <div className="mt-8">
